...
# geography = "County"
# compare = "sp"
# res_sp = kappa_extremist_bothYears_SenPresGov_FUNCTION(geography = "County", compare = "sp")
# res_sp = kappa_extremist_bothYears_SenPresGov_FUNCTION(geography = "State", compare = "sp")

## Figure function
betaFigure_extremist_SenPresGov_FUNCTION = function(geography = "County"){
